...
PROMPTS = {
    "tarzan": """Video game character sprite of Tarzan, a heroic jungle man. Athletic muscular man in his late 20s with wild untamed dark hair and confident determined expression. He wears simple jungle attire - a loincloth or tattered shorts, bare chest showing defined muscles, bare feet. Tanned skin from living in the jungle. Standing in a confident heroic pose, ready for adventure. Full body view, dynamic pose showing strength and agility. TRANSPARENT BACKGROUND - no background, isolated character on transparent/alpha background for game sprite use. Style: Hand-painted 1990s adventure game art like King's Quest V, Monkey Island 2. Rich saturated colors, detailed painterly brushwork, warm dramatic lighting. Professional video game character sprite, high detail, expressive. PNG with transparency.""",
